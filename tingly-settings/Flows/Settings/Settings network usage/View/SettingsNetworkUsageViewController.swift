//
//  SettingsNetworkUsageViewController.swift
//  tingly-settings
//
...
class SettingsNetworkUsageViewController: UIViewController {
  ...
  var presenter: SettingsNetworkUsageViewOutput?
...
extension SettingsNetworkUsageViewController: SettingsNetworkUsageViewInput {
