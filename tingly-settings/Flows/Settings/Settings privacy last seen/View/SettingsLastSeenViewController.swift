//
//  SettingsLastSeenViewController.swift
//  tingly-settings
//
...
class SettingsLastSeenViewController: UIViewController {
  ...
  var presenter: SettingsLastSeenViewOutput?
...
extension SettingsLastSeenViewController: SettingsLastSeenViewInput {
