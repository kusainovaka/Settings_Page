//
//  SettingsImageTitleWithDeleteSectionCell.swift
//  tingly-settings
//
...
class SettingsImageTitleWithDeleteSectionCell: UITableViewCell {

  private var model: SettingsImageTitleWithDeleteSectionModel!
  ...
  private lazy var detailButton: UIButton = {
    ...
    button.setImage(#imageLiteral(resourceName: "delete-red"), for: .selected)
    return button
  }()
  ...
  override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
    ...
    [ backgroundCell.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -3),
      ...
      backgroundCell.heightAnchor.constraint(equalToConstant: 54)
...
extension SettingsImageTitleWithDeleteSectionCell: TableViewCellProtocol {
  func configure(model: TableViewCellModelProtocol) {
    guard let cellModel = model as? SettingsImageTitleWithDeleteSectionModel else {
