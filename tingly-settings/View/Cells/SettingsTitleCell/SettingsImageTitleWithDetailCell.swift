//
//  SettingsImageTitleWithDetailCell.swift
//  tingly-settings
//
...
class SettingsImageTitleWithDetailCell: UITableViewCell {

  private var model: SettingsImageTitleWithDetailModel!
  ...
  override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
    ...
    [ detailLabel.centerYAnchor.constraint(equalTo: backgroundCell.centerYAnchor),
      detailLabel.trailingAnchor.constraint(equalTo: detailButton.leadingAnchor, constant: -11),
...
extension SettingsImageTitleWithDetailCell: TableViewCellProtocol {
  func configure(model: TableViewCellModelProtocol) {
    guard let cellModel = model as? SettingsImageTitleWithDetailModel else {
